...
export default function LoginScreen() {
  const { login, switchAuthScreen } = useApp();
    ...
    <div className="auth-screen">
      <div className="auth-card">
        <div className="auth-brand">
          ...
          <p className="auth-brand__tagline">No Kenyan should disappear without a trace.</p>
        </div>
        ...
        <p className="auth-switch">
          ...
          <button className="auth-switch__link" onClick={() => switchAuthScreen('signup')}>
            Sign Up
          </button>
        </p>
      </div>
